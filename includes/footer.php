            ...
            <div class="lg:col-span-2">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex gap-3">
                        <a href="https://www.facebook.com/samaarohweddings" class="w-10 h-10 bg-blue-600 hover:bg-blue-700 rounded-lg flex items-center justify-center text-white transition-all duration-300 group">
                        ...
                        <a href="https://www.instagram.com/samaarohweddings" class="w-10 h-10 bg-gradient-to-br from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 rounded-lg flex items-center justify-center text-white transition-all duration-300 group">
                            <svg class="h-5 w-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="https://wa.me/919876543210" class="w-10 h-10 bg-green-600 hover:bg-green-700 rounded-lg flex items-center justify-center text-white transition-all duration-300 group">
                            <svg class="h-5 w-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="https://www.linkedin.com/company/samaarohweddings" class="w-10 h-10 bg-blue-700 hover:bg-blue-800 rounded-lg flex items-center justify-center text-white transition-all duration-300 group">
                            <svg class="h-5 w-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
